...
SMTPClient.prototype.sendCommand = function(str) {
    ...
    // sendCommand is called within quit() and there seems to be some conditions
    // (e.g. multiple simultaneous ConnectionPool.close() calls)
    // where this.socket exists, but this.socket.write is not a function
    this.socket && this.socket.write && this.socket.write(new Buffer(str + '\r\n', 'utf-8'));
};
